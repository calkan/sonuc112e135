...
% SHATLYK: Buraya hybrid assembly ve MHAP uzerine ozet gelebilir
...
\addcontentsline{toc}{subsection}{3.1. Havuzlanmış klon dizileme ile genom iskeleleme}
...
{\bf \large 3.2. Birden fazla platform verisi ile genom birleştirmelerde hata düzeltimi}
\addcontentsline{toc}{subsection}{3.2. Birden fazla platform verisi ile genom birleştirmelerde hata düzeltimi}

\input{bac_pinar_methods.tex}

{\bf \large 3.3. Illumina ve PacBio verilerini kullanan hibrit birleştirme algoritması}
\addcontentsline{toc}{subsection}{3.3. Illumina ve PacBio verilerini kullanan hibrit birleştirme algoritması}


{\bf 3.3.1. Hızlı Illumina-PacBio hizalanması için filtreleme}
\addcontentsline{toc}{subsubsection}{3.3.1. Hızlı Illumina-PacBio hizalanması için filtreleme}

\input{canfirtina_methods.tex}

{\bf 3.3.2. Hiperçizge tabanlı birleştirme algoritması}
\addcontentsline{toc}{subsubsection}{3.3.2. Hiperçizge tabanlı birleştirme algoritması}

\input{shatlyk_methods.tex}


{\bf \large 3.4. Ekzom Dizilemede GC ve Yakalama Verimi Hatalarının Düzeltilmesi}
\addcontentsline{toc}{subsection}{3.4. Ekzom Dizilemede GC ve Yakalama Verimi Hatalarının Düzeltilmesi}
...
\addcontentsline{toc}{subsubsection}{3.4.1. Birden Fazla Örnek Üzerinde Çalışabilmek için Ekzom Dizileme Verilerinin Uyarlanması}
...
\addcontentsline{toc}{subsubsection}{3.4.2. GC İçeriği Yanlılığı}
...
\addcontentsline{toc}{subsubsection}{3.4.3. Batch Etkisi}
...
\addcontentsline{toc}{subsubsection}{3.4.4. Temel İçerik Analizi (Principal Component Analysis)(PCA)}
...
\addcontentsline{toc}{subsubsection}{3.4.5. Değişken Bayes Çıkarımı}
...
\addcontentsline{toc}{subsubsection}{3.4.6. GC ve yakalama etkinliğinden doğan farklılıkların düzeltilmesi}
