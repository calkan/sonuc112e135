...
\addcontentsline{toc}{subsection}{3.3 Ekzom Dizilemede GC ve Yakalama Verimi Hatalarının Düzeltilmesi}
...
\addcontentsline{toc}{subsubsection}{3.3.1. Birden Fazla Örnek Üzerinde Çalışabilmek için Ekzom Dizileme Verilerinin Uyarlanması}
...
\addcontentsline{toc}{subsubsection}{3.3.2 GC İçeriği Yanlılığı}
...
\addcontentsline{toc}{subsubsection}{3.3.3 Batch Etkisi}
...
\addcontentsline{toc}{subsubsection}{3.3.4 Temel İçerik Analizi (Principal Component Analysis)(PCA)}
...
\addcontentsline{toc}{subsubsection}{3.3.5. Değişken Bayes Çıkarımı}
...
\addcontentsline{toc}{subsubsection}{3.3.6. GC ve yakalama etkinliğinden doğan farklılıkların düzeltilmesi}
...
Bu projede kullandığımız programları hem en uzun (kromozom 1), hem de en kısa (kromozom 20) verileri üzerinde test ettik. Her iki kromozom için ikişer farklı strateji uyguladık. Önce havuzlanmış BYK verilerinin tümünü kullanarak iskeleleme yaptık (Tablo~\ref{tab:chr1w}, \ref{tab:chr20w}), daha sonra havuzları sırayla teker teker ekleyerek iskeleleme deneyi 
...
\addcontentsline{toc}{subsection}{4.3 Ekzom Dizilemede GC ve Yakalama Verimi Hatalarının Düzeltilmesi}
